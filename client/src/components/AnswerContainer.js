		...
		<Fragment>
			<Grid container spacing={0} style={{ padding: '15px 0px' }}>
				...
				<Grid item container direction='column' xs={10} md={11} lg={11}>
					<Grid item container>
						<Grid item xs={11}>
							<Typography  variant='body2' style={{ color: '#0000008a',marginBottom:'15px' }}>
								Answered by{' '}
								{author
					...
					<Grid item>
						<Typography style={{marginBottom:'10px'}} variant='body1'>{text ? text : ''}</Typography>
						<IconButton
						size='small'
					...
					<Typography variant='button' style={{ padding: '5px', color:'gren' }}>
						Vote
					</Typography>
					<IconButton
						size='small'
