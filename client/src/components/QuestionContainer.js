...
const QuestionContainer = ({ question }) => {
	...
	return (
		<Grid container spacing={0} style={{ paddingBottom: '15px', border: '1px solid gray', borderRadius: '10px'}}>
			<Grid
				item
				container
				direction='column'
			...
			<Grid item xs={10} md={11} lg={11}>
				...
				<Typography variant='h4' style={{borderBottom:'1px solid gray', marginBottom:'15px', color: '#2568FB'}}>
					{question.title ? question.title : ''}
				</Typography>
				<Typography variant='body1' style={{marginBottom:'10px', borderBottom:'1px solid gray'}}>
